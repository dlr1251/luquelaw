...
export function WhatsAppFloatingButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-[65] inline-flex h-14 w-14 items-center justify-center rounded-full border border-[color:var(--caramel)] bg-[color:var(--forest)] text-[color:var(--cream)] shadow-lg transition hover:bg-[color:var(--cream)]/10 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[color:var(--caramel)]"
    >
