  ...
  return (
    <div
      className={cn(
        ...
        "[&_ul.clkr-framework-list]:list-none [&_ul.clkr-framework-list]:pl-0 [&_ul.clkr-framework-list]:space-y-5",
        "[&_ul.clkr-framework-meta]:mt-2 [&_ul.clkr-framework-meta]:list-none [&_ul.clkr-framework-meta]:pl-0 [&_ul.clkr-framework-meta]:space-y-1",
