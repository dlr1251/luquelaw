  ...
  return (
    <div
      className={cn(
        ...
        "[&_a]:font-medium [&_a]:text-[color:var(--caramel)] hover:[&_a]:underline",
        ...
        "[&_h3]:mt-8 [&_h3]:scroll-mt-24 [&_h3]:font-[family-name:var(--font-refinement),ui-serif,Georgia,serif] [&_h3]:text-xl [&_h3]:font-normal [&_h3]:italic [&_h3]:leading-snug [&_h3]:text-[color:var(--ink)]",
        "[&_p]:mt-4 [&_p]:max-w-none",
        "[&_ul]:mt-4 [&_ul]:list-disc [&_ul]:pl-6 [&_ul]:space-y-2",
        "[&_ol]:mt-4 [&_ol]:list-decimal [&_ol]:pl-6 [&_ol]:space-y-2",
        "[&_li]:max-w-none",
        "[&_blockquote]:mt-6 [&_blockquote]:border-l-2 [&_blockquote]:border-[color:var(--caramel)] [&_blockquote]:pl-4 [&_blockquote]:text-[color:var(--muted)]",
        "[&_code]:bg-[color:var(--surface)] [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:font-mono [&_code]:text-[13px]",
        "[&_hr]:my-10 [&_hr]:border-[color:var(--caramel)]/35",
        className,
      )}
    >
      {children}
