...
export const normsHubContent = {
  en: {
    ...
    browseSubtitle:
      "Filter by area or document type. Open a section, or use continuous reader for the full text.",
    ...
    howItWorks: [
      ...
      "Use the sidebar table of contents to jump between titles, chapters, and articles — or open continuous reader for the full text.",
    ...
    read: "Open norm",
    readerMode: "Read continuously",
    articleByArticle: "Article by article",
  ...
  es: {
    ...
    browseSubtitle:
      "Filtra por rama o tipo de documento. Abre una sección, o lee el texto de corrido.",
    ...
    howItWorks: [
      ...
      "Usa la tabla de contenidos lateral para saltar entre títulos, capítulos y artículos — o abre la lectura continua para el texto completo.",
    ...
    read: "Abrir norma",
    readerMode: "Leer de corrido",
    articleByArticle: "Artículo por artículo",
