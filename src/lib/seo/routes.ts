...
export const STATIC_ROUTE_PAIRS = [
  { en: "/", es: "/es" },
  { en: "/clkr", es: "/es/clkr" },
  { en: "/clkr/library", es: "/es/clkr/library" },
...
export const SITEMAP_STATIC_PATHS = [
  ...
  { path: "/clkr/library", priority: 0.7 },
  { path: "/es/clkr/library", priority: 0.7 },
  { path: "/clkr/agents", priority: 0.7 },
  { path: "/es/clkr/agents", priority: 0.7 },
