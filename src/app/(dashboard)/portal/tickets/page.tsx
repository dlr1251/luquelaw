    ...
    <div className="mx-auto w-full max-w-3xl space-y-6">
      {sp.escalated ? (
        <p className="rounded border border-green-200 bg-green-50 px-3 py-2 text-sm text-green-900">
          Lucy AI consultation sent to the firm. We&apos;ll notify you here when the verified answer is
          ready to unlock.
        </p>
      ) : null}
      {sp.unlock === "success" ? (
      ...
      {canCreate ? (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Lightweight request to the firm—not an expediente. For Lucy AI lawyer reviews, escalate
              from a chat.
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Client plan unlocks general firm tickets. Lucy AI consultations appear below when you
