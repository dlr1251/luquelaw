...
In the case of day to day activities, the common sense is what will keep you out the tourist trap. Getting informed, asking in the local facebook groups, having a local friend and learning the language will get you a long way. For more pricey operations, knowing the appliable rules will get you a support for negotiating.
